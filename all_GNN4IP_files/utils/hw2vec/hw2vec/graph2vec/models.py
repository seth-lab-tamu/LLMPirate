...
class GRAPH2VEC(nn.Module):
    ...
    def load_model(self, model_config_path, model_weight_path):
        ...
        self.load_state_dict(torch.load(model_weight_path,map_location=torch.device('cpu')))  ## Added by Vasudev to load pretrained model weights on my CPU run
        #print("Loaded weights")

    def set_graph_conv(self, convs):
        #print("Setting graph_conv")
        self.layers = []
